...
## Current Status
In Lab 02, we reviewed six possible IT opportunities, scored them using NUF, and selected the peer tutoring booking platform as our semester project idea.
